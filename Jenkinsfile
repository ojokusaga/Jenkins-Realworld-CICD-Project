...
pipeline {
        ...
        steps {
           // dir('realworld-cicd-pipeline-project-main/') {
            withSonarQubeEnv('SonarQube') { 
                ...
                sh """
                mvn sonar:sonar \
                -Dsonar.JavaWebApp-Project \
                -Dsonar.host.url=http://172.31.18.109:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#pros-prest-jenkins-cicd-pipeline', //update and provide your channel name
